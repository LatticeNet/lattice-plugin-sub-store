...
Release automation must build both Linux runtime binaries, build the UI, pack a
deterministic artifact, set `bundle.digest_sha256`, sign the manifest with the
trusted LatticeNet Ed25519 publisher seed, and publish the alpha release without
making it GitHub Latest.
